      ...
      <div className="container-pro py-16 sm:py-24 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-sm text-slate-300">By <span className="font-semibold text-white">Shivanshu Sharma</span></p>
              <h1 className="mt-2 text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight text-white">
