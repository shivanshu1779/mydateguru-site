    ...
    <section id="projects" className="border-t border-white/10 bg-slate-950">
      <div className="container-pro py-16 sm:py-20">
        <div className="flex items-end justify-between gap-4">
          ...
          <a href="https://github.com/shivanshu1779" target="_blank" rel="noreferrer" className="hidden sm:inline-flex rounded-xl bg-white/10 px-4 py-2 text-sm text-white hover:bg-white/15">View All</a>
        </div>
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6">
          {projects.map((p) => (
            <article key={p.title} className="group rounded-2xl border border-white/10 bg-gradient-to-b from-slate-900 to-slate-800 p-6 hover:shadow-2xl transition">
              ...
              <div className="mt-4">
                <a href="https://github.com/shivanshu1779" target="_blank" rel="noreferrer" className="text-sm text-brand-400 hover:underline">Open repo →</a>
              </div>
            </article>
          ))}
        </div>
